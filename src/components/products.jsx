...
const Products = () => {
  ...
  return (
    <div className='texts-center p-3'>
    <section className="md:grid grid-cols-3 gap-4 items-center">
      {cars.map((car) => (
        <article
          key={car.key}
          className="bg-white mt-4 rounded overflow-hidden shadow-md"
        >
          <div className="relative">
            ...
            />
            <button className="absolute border-none top-2 rounded flex bg-black text-orange-500 p-1 cursor-pointer overflow-hidden">
              <HiOutlineShoppingCart fontSize={24} />
              <span className="text-white">Add</span>
            </button>
            <span className="bg-sky-100 rounded w-16 texts-center texts-sm p-3">
              ${car.price}
            </span>
            <div className="p-4">
